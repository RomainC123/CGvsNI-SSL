...
python ./main.py --train-test --folder CIFAR10_test_nb_labels --name 100 --data CIFAR10 --nb_samples_test 10000 --nb_samples_labeled 100 --img_mode RGB --model SimpleNet --max_lr 0.0003 --method TemporalEnsembling --epochs 300 --no-verbose