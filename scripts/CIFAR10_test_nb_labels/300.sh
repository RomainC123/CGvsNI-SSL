...
python ./main.py --train-test --folder CIFAR10_test_nb_labels --name 300 --data CIFAR10 --nb_samples_test 10000 --nb_samples_labeled 300 --img_mode RGB --model SimpleNet --max_lr 0.0003 --method TemporalEnsemblingNewLoss --epochs 300 --no-verbose