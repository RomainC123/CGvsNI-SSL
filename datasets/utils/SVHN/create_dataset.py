...
with requests.get('https://ufldl.stanford.edu/housenumbers/train.tar.gz', allow_redirects=True) as r:
    open('train_32x32.mat', 'wb').write(r.content)

with requests.get('https://ufldl.stanford.edu/housenumbers/test.tar.gz', allow_redirects=True) as r:
